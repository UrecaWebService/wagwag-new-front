...
const WaggleView2 = styled.h4`
  ...
  color: #a7a7a7;
`;
const WaggleNickName2 = styled.h4`
  position: absolute;
  margin: 38vw 0 0 1.4vw;
  font-family: "Pretendard-Medium";
  font-size: 0.93vw;
  color: #a7a7a7;
`;
const WaggleText = styled.h4`
  position: absolute;
  margin: 40.4vw 0 0 1.4vw;
  font-family: "Pretendard-Medium";
  font-size: 1.09vw;
  color: #a7a7a7;
`;
...
const ArrowComponent = styled(Arrow)`
  ...
  fill: #525252;
`;
const ArrowComponent2 = styled(Arrow)`
  margin-left: 1.14vw;
  fill: white;
`;
    ...
    <>
      <BackGroundColor>
        <Topbar>
          ...
          <IconTextContainer>
            <VideoIconImg />{" "}
            <LocationText2>오늘 올라온 영상 갯수</LocationText2>
            <LocationText3>43</LocationText3>
          </IconTextContainer>
          <IconTextContainer>
            <RankingIconImg /> <LocationText2>우리동네 와글 순위</LocationText2>
            <LocationText3>2위</LocationText3>
          </IconTextContainer>
          <IconTextContainer>
            <HotIconImg /> <LocationText2>우리동네 핫한 키워드</LocationText2>
            <LocationText4 isBig>#버스킹</LocationText4>
          </IconTextContainer>
          <IconTextContainer>
            <StarIconImg /> <LocationText2>인기 와글</LocationText2>
            <LocationText4>4. 이대 앞 휘낭시에 여기가 대박임</LocationText4>
          </IconTextContainer>
        </Topbar>
        <SideBarComponent />
        <WaggleTitleContainer>
          <WaggleTitle>서대문구 대현동</WaggleTitle>
          <WaggleTitle2>인기 와글</WaggleTitle2>
          <ArrowComponent></ArrowComponent>
          <ArrowComponent2></ArrowComponent2>
        </WaggleTitleContainer>
        <WaggleContainer>
          <WaggleComponent>
            <Waggle>
        ...
        <CategoryWaggle>
          <WaggleView2>3.9K</WaggleView2>
          <WaggleNickName2>yoyoBaek</WaggleNickName2>
          <WaggleText>기타치면서 불러본 Antifreeze</WaggleText>
        </CategoryWaggle>
        <FooterComponent />
      </BackGroundColor>
    </>
